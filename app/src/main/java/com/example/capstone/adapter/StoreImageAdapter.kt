...
class StoreImageAdapter(val mode:Int, val clickListener: OnPreviewImageClick2) : RecyclerView.Adapter<StoreImageAdapter.ImagePreviewViewHolder>() {
    ...
    override fun onBindViewHolder(
        holder: StoreImageAdapter.ImagePreviewViewHolder,
        position: Int
    ) {
